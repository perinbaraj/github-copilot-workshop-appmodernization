...
- 🎯 **Starter Code** - A legacy Java application with modernization opportunities.
- 🧪 **Tests** - A test suite to validate your solutions.
- 📝 `SOLUTION_GUIDE.md` - Detailed solutions and explanations.
- 💡 `COPILOT_PROMPTS.md` - Effective prompt examples for Copilot.

## 🚀 Getting Started

### Prerequisites
1.  **GitHub Copilot Access** - Ensure you have GitHub Copilot enabled.
2.  **VS Code Setup** - Install VS Code with the GitHub Copilot and GitHub Copilot App Modernization extensions.
3.  **Java Development Kit (JDK)** - JDK 17 or later installed.
4.  **Maven** - Apache Maven 3.6 or later installed.
...
cd challenges/01-monolith-to-microservices  # or any challenge folder
